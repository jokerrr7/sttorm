...
DevId = Config.DevId
SudoIds = {Config.SudoIds,1984004657,1983090473,1984004657}
storm = Config.storm
...
❁︙م6 ⤽ اوامر الاعضاء
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
❁︙[𝗧𝗘𝗔𝗠 𝗦𝗧𝗢𝗥𝗠 ⤓ ](https://t.me/So_ST0RM)
]] 
keyboard = {} 
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '❁︙العضو ⤽ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'So_ST0RM')..')'..' ❩\n❁︙تم رفعه ❨ '..DEV_RIO..' ❩ بنجاح', 1, 'md')
...
if mrrio == "مميز" and VipMem(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '❁︙العضو ⤽ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'So_ST0RM')..')'..' ❩\n❁︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
...
local inline = {
{{text="❁ المطور .",url="t.me/"..(dp.username_ or "So_ST0RM")}},
{{text="❁ السورس .",url="https://t.me/So_ST0RM"},{text="❁ لتنصيب بوت .",url="https://t.me/AHMED_MERO_love"}},{{text="❁ اضفني في مجموعتك .",url="t.me/"..dp.username_.."?startgroup=botstart"}}
}
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'channel',url="t.me/SO_ST0RM_TW"}},
}
{{text = 'DEV¹',url="t.me/JE_K_A1"}},
}
{{text = 'DEV²',url="t.me/Xx_BoDa_UXB"}},
}
{{text = 'Communication',url="t.me/tw_So_Storm_BOT"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/SO_ST0RM_TW&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
{
{text = '𝙈𝙔 𝘾𝙃𝘼𝙉𝙀𝙀𝙀𝙇  ', url="t.me/So_ST0RM"},
},
}
local msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '《𝗧𝗘𝗔𝗠 𝗦𝗧𝗢𝗥𝗠 》', url="t.me/So_ST0RM"}},
}
local msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '❁ قناة السورس',url="t.me/So_ST0RM"}},
}
local msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '❁ مبرمج السورس',url="t.me/Xx_BoDa_UXB"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text == "مبرمج جاك" and ChCheck(msg) or text == "مطور جيكا" and ChCheck(msg) or text == "جيكا" and ChCheck(msg) or text == "المبرمج" and ChCheck(msg) or text == "⤽ المبرمج جيكا ❁" and ChCheck(msg) then 
Text = [[
❁︙[مبرمج السورس](https://t.me/JE_K_A1)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '❁ مبرمج السورس',url="t.me/JE_K_A1"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/X_x_b0dy_x_X&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
