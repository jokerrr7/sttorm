...
if text and text:match('^'..(DevRio:get(storm..'Rio:NameBot') or "ستورم")..' ') then
data.message_.content_.text_ = data.message_.content_.text_:gsub('^'..(DevRio:get(storm..'Rio:NameBot') or "ستورم")..' ','')
end
...
{{text = '❁ storm team .', url="t.me/Xx_b0dY_cV"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
if text and text == (DevRio:get(storm..'Rio:NameBot') or 'ستورم') then 
NameBot = (DevRio:get(storm..'Rio:NameBot') or 'ستورم')
...
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/blacckir/3&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))  
end
