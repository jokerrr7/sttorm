...
{{text="❁ السورس .",url="https://t.me/So_ST0RM"},{text="❁ لتنصيب بوت .",url="https://t.me/tw_So_Storm_BOT"}},{{text="❁ اضفني في مجموعتك .",url="t.me/"..dp.username_.."?startgroup=botstart"}}
}
...
Text = [[
❁︙𝒘𝒆𝒍𝒄𝒐𝒎𝒆 𝒕𝒐 𝒔𝒐𝒖𝒓𝒄𝒆 storm 彡
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '❁ 𝒔𝒐𝒖𝒓𝒄𝒆 storm 彡',url="http://t.me/So_ST0RM"}},
{{text = '❁ 𝒅𝒆𝒗 父',url="http://t.me/JE_K_A1"}},
{{text = '❁ 𝒅𝒆𝒗 父',url="http://t.me/Xx_BoDa_UXB"}},
{{text = '❁ TWS 父',url="http://t.me/tw_So_Storm_BOT"}},
}
local msg_id = msg.id_/2097152/0.5
