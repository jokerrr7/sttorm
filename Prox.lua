------------------------------------------------
-- This Source Was Developed By Joker
--   This Is The 𝗧𝗘𝗔𝗠 𝗦𝗧𝗢𝗥𝗠 ⤓  @UUOUOU_7 .   --
--                - Prox -                 --
--        -- https://t.me/Xx_b0dY_cV --         --
------------------------------------------------ 
...
DevId = Config.DevId
SudoIds = {Config.SudoIds,1984004657,1765160742,1984004657}
Prox = Config.Prox
TokenBot = Config.TokenBot
NameBot = (DevRio:get(Prox..'Rio:NameBot') or 'ستورم')
--     Source Storm     --
...
local UserName = (dp.username_ or "Xx_b0dY_cV")
...
❁︙م6 ⤽ اوامر الاعضاء
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
❁︙[𝗧𝗘𝗔𝗠 𝗦𝗧𝗢𝗥𝗠 ⤓ ](https://t.me/Xx_b0dY_cV)
]] 
keyboard = {} 
...
if text and text:match('^'..(DevRio:get(Prox..'Rio:NameBot') or "ستورم")..' ') then
data.message_.content_.text_ = data.message_.content_.text_:gsub('^'..(DevRio:get(Prox..'Rio:NameBot') or "ستورم")..' ','')
end
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '❁︙العضو ⤽ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'Xx_b0dY_cV')..')'..' ❩\n❁︙تم رفعه ❨ '..DEV_RIO..' ❩ بنجاح', 1, 'md')
...
if mrrio == "مميز" and VipMem(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '❁︙العضو ⤽ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'Xx_b0dY_cV')..')'..' ❩\n❁︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
...
if text == '⤽ العاب ❁' then 
local Sudo_Welcome = '❁︙اهلا بك مجددا عزيزي \n❁︙اليك الازرار الخاصه بألعاب سورس ستورم فقط اضغط على اللعبه الذي تريد لعبها'
local key = {
...
local inline = {
{{text="❁ المطور .",url="t.me/"..(dp.username_ or "Xx_b0dY_cV")}},
{{text="❁ السورس .",url="https://t.me/Xx_b0dY_cV"},{text="❁ لتنصيب بوت .",url="https://t.me/AHMED_MERO_love"}},{{text="❁ اضفني في مجموعتك .",url="t.me/"..dp.username_.."?startgroup=botstart"}}
}
...
Dev_Rio(msg.sender_user_id_, msg.id_, 1, '❁︙تم ارسال رسالتك الى [المطور](t.me/'..(chat.username_ or "Xx_b0dY_cV")..')', 1, 'md') 
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = ''..result.first_name_..' ',url="t.me/"..result.username_ or Xx_b0dY_cV}}}
...
{{text = '❁ Siria team .', url="t.me/Xx_b0dY_cV"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
local Welcomes = Welcomes:gsub('username',('[@'..result.username_..']' or '[@Xx_b0dY_cV]'))
...
local Welcomes = Welcomes:gsub('username',('[@'..msg.content_.members_[0].username_..']' or '[@Xx_b0dY_cV]'))
Dev_Rio(msg.chat_id_, msg.id_, 1, Welcomes, 1, 'md')
end
--     Source Storm     --
--        Contact         --
...
local BotName = (DevRio:get(Prox.."Rio:NameBot") or 'ستورم')
...
if text and text == (DevRio:get(Prox..'Rio:NameBot') or 'ستورم') then 
NameBot = (DevRio:get(Prox..'Rio:NameBot') or 'ستورم')
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '  𝗱𝗲𝘃¹  𖠅 ',url="t.me/X_x_b0dy_x_X"}},
{{text = '  𝗱𝗲𝘃²  𖠅 ', url="t.me/U_JEKA_U"}},
{{text = '  𝙈𝙔 𝘾𝙃𝘼𝙉𝙀𝙀𝙀𝙇 𖠅  ', url="t.me/Xx_b0dY_cV"}},
}
https.request("https://api.telegram.org/bot"..token..'/sendanimation?chat_id=' .. msg.chat_id_ .. '&animation=https://t.me/Xx_b0dY_cV/3&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
tdcli_function ({ID = "GetUser",user_id_ = 1984004657,},function(arg,result) 
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = ' 𝗦𝗨𝗥𝗖𝗘 𝗗𝗘𝗩𝗘𝗟𝗢𝗣𝗘𝗥\n['..result.first_name_..'](t.me/X_x_b0dy_x_X)\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '  ❨ '..result.first_name_..'  ❩ ',url="t.me/X_x_b0dy_x_X"},
},
{
{text = '𝙈𝙔 𝘾𝙃𝘼𝙉𝙀𝙀𝙀𝙇  ', url="t.me/Xx_b0dY_cV"},
},
}
local msg_id = msg.id_/2097152/0.5
...
tdcli_function ({ ID = "GetUserProfilePhotos", user_id_ = 1984004657, offset_ = 0, limit_ = 1 }, taha, nil)
end,nil)
end
end
if text == 'سورس بلاك' or text == 'بلاك' then  
local Text = [[  
افضل سورس في التليجرام
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = 'TEAM BLACK',url="t.me/BLACK_TEAM_4"}},  
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '《𝗧𝗘𝗔𝗠 𝗦𝗧𝗢𝗥𝗠 》', url="t.me/Xx_b0dY_cV"}},
}
local msg_id = msg.id_/2097152/0.5
...
if tonumber(result.sender_user_id_) == tonumber(1984004657) then  
Dev_Rio(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md')
return false
end 
...
if LinkGp.ok == true then LinkGroup = LinkGp.result else LinkGroup = 't.me/Xx_b0dY_cV' end
...
ConstructorRio = "["..Rio.first_name_.."](T.me/"..(Rio.username_ or "Xx_b0dY_cV")..")"
else 
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '❁︙جاري تحديث سورس ستورم', 1, 'md') 
...
DevRio:set(Prox..'Rio:NameBot',(DevRio:get(Prox..'Name:Bot') or 'ستورم'))
end
for i = 1, #Users do
local id = Users[i]
if id:match("^(%d+)") then
...
Text = [[
❁︙[قناة السورس](https://t.me/Xx_b0dY_cV)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '❁ قناة السورس',url="t.me/Xx_b0dY_cV"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Xx_b0dY_cV&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
--     Source Storm     --
if text == "مبرمج السورس" and ChCheck(msg) or text == "مطور السورس" and ChCheck(msg) or text == "بودي" and ChCheck(msg) or text == "المبرمج" and ChCheck(msg) or text == "⤽ مبرمج السورس ❁" and ChCheck(msg) then 
Text = [[
❁︙[مبرمج السورس](https://t.me/X_x_b0dy_x_X)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '❁ مبرمج السورس',url="t.me/X_x_b0dy_x_X"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/X_x_b0dy_x_X&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
--     Source Storm     --
